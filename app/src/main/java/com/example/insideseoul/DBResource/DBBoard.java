...
public class DBBoard extends SQLiteOpenHelper {
    ...
    public void initSettingValue() {
        ...
        subject[42] = "2019 구로구 공정무역 포트나잇 개최";
        start_date[42] = "2019-09-28";
        end_date[42] = "2019-10-12";
        a_link[42] = "https://www.guro.go.kr/www/event/NR_view.do?eventSeq=1845";
        intro_text[42] = "공정무역 포트나잇은 마을에서 세상을 바꾸는 2주간의 공정무역 시민축제입니다. 공정무역과 함께하는 특별한 2주 동안, 카페와 생협, 학교와 마을모임 등 구로 곳곳에서 공정무역을 알리고 나누는 다양한 만남과 캠페인이 펼쳐집니다. 공정무역 포럼과 영화제, 공정무역 공부모임부터 공정무역 티파티까지 다양한 호흡과 리듬으로 2주 동안 삶의 곳곳에 공정무역이 깃드는 일상의 축제를 함께 즐겨요  <구로 공정무역 포럼> ○ 일시 : 2019년 9월 30일(월) 오전 10시 30분 ○ 장소 : 성공회대학교 이천환관 시청각실 ○ 문의 : 구로사회적경제통합지원센터 (02-3666-9845)   <구로 공정무역 영화제> ○ 일시 : 2019년 10월 1일(화) 오전 10시 30분 ○ 장소 : 오류문화센터 2층 오류아트홀  ○ 문의 : 구로사회적경제통합지원센터 (02-3666-9845)  **영화제 및 포럼에 사전 신청하고 참여하시면 선착순 200명에 공정무역 쿠폰과 기념품 증정합니다~  <포럼 및 영화제 신청> https://forms.gle/a9tpTiDcHhMR7Fm7A";
        event_location[42] = "";
        image1[42] = "GU16_2.jpg";
        image2[42] = "";
        gu[42] = "GU16";

        subject[43] = "2019 금천 과학 페스티벌";
        start_date[43] = "2019-10-11";
        end_date[43] = "2019-10-12";
        a_link[43] = "https://www.geumcheon.go.kr/program/gc_science_festival/";
        intro_text[43] = "2019 금천 과학 페스티벌 「G-Science Day」 4차 산업혁명의 시대, 과학 도시로 발돋움하는 금천의 첫 번째 과학 이야기! 미래과학기술을 직접 보고, 듣고, 체험할 수 있는 특별한 기회 진로박람회, 미래교육축제와 더불어 더 풍성한 축제 ■ 일 시 2019. 10. 11.(금) ~ 10. 12.(토) 10:00~17:00 ※ 기념식 : 2019. 10. 12.(토) 11:00(예정) ■ 장 소 금천구청 로비 및 광장, 썬큰광장, 금나래공원 일대 ■ 탐(구)! 탐(색)! 탐(험)! 거리 가상현실(VR) : VR 스포츠교실, HTC 바이브 및 구글카드보드 활용 체험, HMD 방식 VR체험, MR(혼합현실) 체험, VR 액티비티 체험 3D 기술 : 3D 전신스캔, 3D 캐릭터 디자인, 3D펜, 3D 모델링 및 프린팅 드론 : 전문가 드론 시뮬레이터 체험, 완구드론 체험, 드론전시(산업용, 농업용, 전문가용) ※ 드론전용 Zone 운영(썬큰광장) 로봇 : 인공지능 로봇 시연, 로봇 코딩, 로봇 댄스 기타 : AR러닝패드, 4D 무비카, 과학체험장비를 이용한 방탈출, 자가 공급 화분 제작, IOT 모형 집 만들기, 센서와 아두이노를 이용한 아이템 제작, 홀로그램 등 진로박람회 : 코딩 전문가, 크리에이터, 스타일리스트, 기상캐스터, 조향사, 반도체전문가, 쥬얼리 전문가, 진로 및 진학상담 등 상시 이벤트 : 인스타그램 자판기, 스마트 캐리커쳐, 타로카드, 페이스페인팅 등";
        event_location[43] = "금천구청 로비 및 광장, 썬큰광장, 금나래공원 일대";
        image1[43] = "GU17_2.png";
        image2[43] = "";
        gu[43] = "GU17";

        subject[44] = "당산골 마을장터 벼룩시장 참여하세요~";
        start_date[44] = "2019-10-19";
        end_date[44] = "2019-10-19";
        a_link[44] = "http://www.ydp.go.kr/main/board/bbs.do?cfgIdx=211&mCode=F040140000&op=view&idxId=234253";
        intro_text[44] = "집에서 잠들어 있는 유아용품, 의류, 도서, 생활용품 등 당산골 마을장터로 가지고 오세요~!! 벼룩시장에 참여하여 이웃과 함께 나누기도 하고, 다양한 체험거리, 먹거리가 있는 마을장터에서 가족과 함께 즐기세요~!!  √ 참여자격: 주민 누구나 √ 참 여 비: 없 음 √ 준 비 물: 돗자리, 팔 물건, 가격표 등 √ 참여신청: 방문, 전화, 이메일 신청(kimmiryang@ydp.go.kr) √ 신청기간: 9월 18일(수) ~ 9월 30일(월) √ 참여문의: 당산1동 주민센터(2670-1106,1117) √ 당산골 마을장터: 10. 19.(토) 11:00~15:00 / 당산골 문화의 거리(영등포로25길 17)  ※ 세부사항은 첨부파일 참고하여주시기 바랍니다~^^";
        event_location[44] = "당산 1동";
        image1[44] = "";
        image2[44] = "";
        gu[44] = "GU18";

        subject[48] = " [2019강남페스티벌] 혜민스님과 함께하는 치유의 시간";
        start_date[48] = "2019-10-01";
        end_date[48] = "2019-10-01";
        a_link[48] = "http://www.gangnam.go.kr/board/article/3431/view.do?mid=FM0508&schArticle=ARTICLE_08";
        intro_text[48] = "‘혜민스님과 함께하는 마음치유 콘서트’가 1일 오후 4시 봉은사 법왕루에서 열린다. 2019 강남페스티벌을 맞아 혜민스님이 특강무대에 선다.   ‘고요할수록 밝아지는 것들’이라는 주제로 진행되는 이번 토크콘서트에서는 고요 속에서 진정한 나를 찾을 수 있는 치유 방법이 소개된다. 삶에 지친 현대인들에게 혜민스님만의 따뜻한 감성으로 응원의 메시지를 전하는 시간이 될 것으로 보인다. ‘고요할수록 밝아지는 것들’은 옛 선사들이 남긴 지혜를 담은 책이다. ‘멈추면 비로소 보이는 것들’(2012), ‘완벽하지 않은 것들에 대한 사랑’(2016)에 이은 혜민의 ‘행복 지침서’ 시리즈 마지막 이야기다. 2018년 12월 출간 이후 교보문고 베스트셀러 8주 연속 1위를 기록했다.    대한민국 대표 힐링멘토인 혜민스님은 ‘멈추면 비로소 보이는 것들’과 ‘완벽하지 않은 것들에 대한 사랑’ 등 다수의 베스트셀러를 집필했다. 마음치유학교를 건립해 경쟁과 스트레스에 휩싸인 현대인들을 돕고 있으며 TV·라디오·SNS 등 다양한 활동으로 대중과 소통하고 있다.   특강은 무료로 진행된다. 구관계자는 “강남의 도심 속 유일 사찰 봉은사가 이번 특강 최적의 장소”라며 “혜민스님과 함께 오롯이 자신에게 집중하는 특별한 힐링 시간이 될 수 있을 것”이라고 말했다.  ";
        event_location[48] = "봉은사 법왕루";
        image1[48] = "GU22_2.jpg";
        image2[48] = "";
        gu[48] = "GU22";

        subject[49] = "송파구 일자리박람회 개최";
        start_date[49] = "2019-10-16";
        end_date[49] = "2019-10-16";
        a_link[49] = "http://www.songpa.go.kr/user.kdf?a=songpa.openadmin.news.NewsApp&c=1002&seq=26080&code=1&cate_id=AG0401000000";
        intro_text[49] = "'내 일자리를 찾아서, 문정컬처밸리로!'   송파구 일자리박람회에 오세요~ 취업을 희망하는 누구나 참여가능합니다.  현장면접 참여기업은 첨부파일을 확인해주세요^^";
        event_location[49] = "문정컬쳐밸리 선큰광장";
        image1[49] = "GU23_2.jpg";
        image2[49] = "";
        gu[49] = "GU23";

        subject[50] = "제1회 성내1동 마을축제 [함께 나누고 즐기는 행복한 과학여행] 안내";
        start_date[50] = "2019-09-23  11:00";
        end_date[50] = "2019-09-23 ";
        a_link[50] = "https://www.gangdong.go.kr/post/41140513421151734?ap=B1140&bbsId=1140";
        intro_text[50] = "제1회 성내1동 마을축제 [함께 나누고 즐기는 행복한 과학여행] 안내";
        event_location[50] = "환영고";
        image1[50] = "GU24_2.jpg";
        image2[50] = "";
        gu[50] = "GU24";
    }
